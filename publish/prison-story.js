...
window.XQ.PrisonStory = (() => {
  const IMAGES = {
    ...
    K: "./assets/generated/prison-piece-king.be788770.webp",
    S: "./assets/generated/prison-piece-bishop.df7d2cc0.webp",
    Q: "./assets/generated/prison-piece-queen.8c7f39b6.webp",
  };
  const RED_KING_IMAGE = "./assets/generated/prison-piece-red-king.573e5002.webp";
...
「这才刚开始呢，我们有的是时间。」夜还很长，而砚秋注定要在这种极致的快乐与痛苦中度过…`, IMAGES.A),
...
云岚的身体轻颤，不知是因为羞辱还是期待。她低头看着还在往下滴落的白浊，两腿间蜜穴一开一合，倏然情动。她第一次对自己的技艺感到既骄傲又迷茫…`, IMAGES.B),
...
指挥官沉默地观察着这一切，直到确认眼前的女子真的陷入癫狂。照夜趴伏在地，撅起丰盈的臀部，手指持续不断地刺激着自己：「求求您…我已经什么都顾不上了…只要能满足我就好…」`, IMAGES.N),
...
「我签！我全都招！求求你让我解脱…」
在极致的快感和痛苦交织中，鸣砂签下了自己的名字。当她再次达到高潮时，整个人虚脱地挂在镣铐上，只有炮架底部传来的嗡嗡声还在提醒着她刚才发生的一切…`, IMAGES.C),
...
「求求你们…不要杀我…我愿意赎罪…」
堂堂女将跪在地上苦苦哀求，额头上的「斩」字随着她的动作而摇晃。没人理会她的话语，只当她是垂死挣扎。木枷的重量压得她几乎窒息，而药膏的作用则让她浑身燥热难当…`, IMAGES.K),
...
「看来神职人员也需要好好管教。」
冰冷的圣水泼在她脸上，短暂的清醒后是更加强烈的欲望。她跪伏在圣坛前，向着自己曾经崇拜的神明坦白一切罪行，而身体却违背意愿地渴求着…`, IMAGES.S),
...
「不要！那是我最喜欢的一对镯子！」
可悲的是，即使在这种时刻，她在意的依然是那些财物而非自身的处境。赤身裸体的她挂在那里，如同被剥皮的祭品，等待着未知的命运…`, IMAGES.Q),
 };
  ...
  const EARLY_DEFEAT = item(
    "红帅关押记录",
    "义军兵败，折戟沉沙。身为义军指挥官的你败于玉足之下，遭兵卒百般榨取，沦为玩物；本轮征程在此结束。",
    RED_KING_IMAGE,
  );

  function item(title, text, image) {
